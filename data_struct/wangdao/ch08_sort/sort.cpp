//
// Created by Edward on 2020/9/11.
//
#include "sort.hpp"
...
void BubbleSort1(ElemType A[] , int n){  // 从后往前 -> 关键字最小的元素如气泡-般逐渐往上“漂浮”直至“水面”
    bool flag;
...
void BubbleSort2(ElemType A[],int n){   // 从前往后 -> 关键字最大的元素如石头一般下沉至水底
